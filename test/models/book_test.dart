...
void main() {
  group('Book', () {
    group('fromMap', () {
      ...
      test('deve converter id double para string', () {
    ...
    group('conversões de tipos dinâmicos', () {
      test('deve ignorar bool como id invalido', () {
      ...
      test('deve manter String de id como valor opaco', () {
